...
class ArticleList extends React.Component {
    ...
    componentWillReceiveProps(newProps) {// draws articles no matter what 
        ...
        axios.get(`http://127.0.0.1:8000/api/articles/?search=${newProps.searchterm}&traded=false`)
            .then(res => {
                this.setState({
                    articles: res.data
                });
    ...
    componentDidMount() {
        if (this.props.searchterm) {
            axios.get(`http://127.0.0.1:8000/api/articles/?search=${this.props.searchterm}&traded=false`)
                .then(res => {
                    this.setState({
                        articles: res.data
                    });
            ...
            axios.get('http://127.0.0.1:8000/api/articles/?traded=false')
                .then(res => {
                    this.setState({
                        articles: res.data
                    });
    ...
    handleSearch = (value) => {
        axios.get(`http://127.0.0.1:8000/api/articles/?search=${value}&traded=false`)
            .then(res => {
                this.setState({
                    articles: res.data
                });
